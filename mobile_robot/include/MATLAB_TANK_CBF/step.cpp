             ...
             default:
              {
                ...
                iy = 0;
                for (idx_upper = 0; idx_upper <= 504; idx_upper += 28) {
                  ix = 0;
                  c = 0.0;
                ...
                iy = 1;
                ix = 20;
                idx_upper = WorkingSet->sizes[3] + 20;
                ...
                if (!stepSuccess) {
                  ...
                  for (idx = 0; idx < nWIneq_old; idx++) {
                    ...
                    ix = 28 * (iy - 1);
                    idx_upper = 28 * (WorkingSet->nActiveConstr - 1);
                  ...
                  for (idx = 0; idx < nWLower_old; idx++) {
                    qpactiveset::WorkingSet::addBoundToActiveSetMatrix_
                      (WorkingSet, 4, TrialState->workingset_old[idx + 19]);
                  }
