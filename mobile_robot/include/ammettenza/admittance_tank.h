#ifndef ADMITTANCE_TANK_H_
#define ADMITTANCE_TANK_H_
...
public:
  ...
  Eigen::MatrixXd compute_arm_jacobian(double joint_position[],
  ...
  Vector8d SatNullSpace(Vector6d cartesian_velocity,
                        Eigen::MatrixXd system_jacobian,
                        Vector8d Vel_LowerLimit, Vector8d Vel_UpperLimit);
...
private:
  ...
  std::ofstream q_dot_prova_file;
  std::ofstream q_dot_prova_uscita_file;
