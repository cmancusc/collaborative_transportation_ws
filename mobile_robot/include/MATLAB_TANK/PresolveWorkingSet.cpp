            ...
            if (mTotalWorkingEq_tmp_tmp > 0) {
              ...
              for (ix = 0; ix < mTotalWorkingEq_tmp_tmp; ix++) {
                for (idx_col = 0; idx_col <= nVar; idx_col++) {
                  qrmanager->QR[ix + 35 * idx_col] = workingset->ATwset[idx_col
                    + 26 * ix];
                }
              }
              ...
              while ((nVar > 0) && (std::abs(qrmanager->QR[(nVar + 35 * (nVar -
                         1)) - 1]) < tol)) {
                nVar--;
                nDepInd++;
              }
              ...
              if (nDepInd > 0) {
                ...
                while ((!exitg1) && (idx <= nDepInd - 1)) {
                  ix = 35 * ((mTotalWorkingEq_tmp_tmp - idx) - 1);
                  qtb = 0.0;
                  nVar = 0;
                    ...
                    if (idx_col <= mWorkingFixed) {
                      if ((workingset->nActiveConstr == mWorkingFixed) ||
                        ...
                        for (mTotalWorkingEq_tmp_tmp = 0;
                             ...
                             mTotalWorkingEq_tmp_tmp++) {
                          workingset->ATwset[mTotalWorkingEq_tmp_tmp + 26 *
                        ...
                        for (mTotalWorkingEq_tmp_tmp = 0;
                          ...
                          workingset->ATwset[mTotalWorkingEq_tmp_tmp + 26 *
                            ...
                            ATwset[mTotalWorkingEq_tmp_tmp + 26 * (mWorkingFixed
                            - 1)];
                        }
                        ...
                        for (mTotalWorkingEq_tmp_tmp = 0;
                          ...
                          workingset->ATwset[mTotalWorkingEq_tmp_tmp + 26 *
                            ...
                            ATwset[mTotalWorkingEq_tmp_tmp + 26 *
                            (workingset->nActiveConstr - 1)];
                        }
