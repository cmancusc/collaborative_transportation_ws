#ifndef ROBOT_REAL_H_
#define ROBOT_REAL_H_
...
class Controller_robot_real {

		public:

			Controller_robot_real();
			~Controller_robot_real();
...
//      Vector8d vel_limits_CBFclose;
      ...
      double tank_state_;
      double tank_energy_;
      const double TANK_INITIAL_VALUE = 30; // was 20
...
//      andrea_filters::RCFilter* force_filter;
