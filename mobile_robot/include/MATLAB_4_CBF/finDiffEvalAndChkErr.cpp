        ...
        namespace FiniteDifferences
        {
          namespace internal
          {
              ...
              delta, double xk[8])
            {
              ...
              *fplus = aInstancePtr->cost_function_4_cbf(xk,
                obj_objfun.tunableEnvironment[0].f1);
              evalOK = ((!rtIsInf(*fplus)) && (!rtIsNaN(*fplus)));
              if (evalOK) {
                int idx;
                aInstancePtr->constraints_4_cbf(xk,
                  ...
                  obj_nonlin->tunableEnvironment.f10,
                  obj_nonlin->tunableEnvironment.f11,
                  obj_nonlin->tunableEnvironment.f12,
                  obj_nonlin->tunableEnvironment.f13,
                  obj_nonlin->tunableEnvironment.f14, cIneqPlus);
                idx = 0;
                while (evalOK && (idx + 1 <= 21)) {
