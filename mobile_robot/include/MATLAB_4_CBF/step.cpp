             ...
             default:
              {
                ...
                iy = 0;
                for (idx_upper = 0; idx_upper <= 600; idx_upper += 30) {
                  ix = 0;
                  c = 0.0;
                ...
                iy = 1;
                ix = 22;
                idx_upper = WorkingSet->sizes[3] + 22;
                ...
                if (!stepSuccess) {
                  ...
                  for (idx = 0; idx < nWIneq_old; idx++) {
                    ...
                    ix = 30 * (iy - 1);
                    idx_upper = 30 * (WorkingSet->nActiveConstr - 1);
                  ...
                  for (idx = 0; idx < nWLower_old; idx++) {
                    qpactiveset::WorkingSet::addBoundToActiveSetMatrix_
                      (WorkingSet, 4, TrialState->workingset_old[idx + 21]);
                  }
