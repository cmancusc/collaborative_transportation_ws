            ...
            if (mTotalWorkingEq_tmp_tmp > 0) {
              ...
              for (ix = 0; ix < mTotalWorkingEq_tmp_tmp; ix++) {
                for (idx_col = 0; idx_col <= nVar; idx_col++) {
                  qrmanager->QR[ix + 43 * idx_col] = workingset->ATwset[idx_col
                    + 30 * ix];
                }
              }
              ...
              while ((nVar > 0) && (std::abs(qrmanager->QR[(nVar + 43 * (nVar -
                         1)) - 1]) < tol)) {
                nVar--;
                nDepInd++;
              }
                    ...
                    if (idx_col <= mWorkingFixed) {
                      if ((workingset->nActiveConstr == mWorkingFixed) ||
                        ...
                        for (mTotalWorkingEq_tmp_tmp = 0;
                             ...
                             mTotalWorkingEq_tmp_tmp++) {
                          workingset->ATwset[mTotalWorkingEq_tmp_tmp + 30 *
                        ...
                        for (mTotalWorkingEq_tmp_tmp = 0;
                          ...
                          workingset->ATwset[mTotalWorkingEq_tmp_tmp + 30 *
                            ...
                            ATwset[mTotalWorkingEq_tmp_tmp + 30 * (mWorkingFixed
                            - 1)];
                        }
                        ...
                        for (mTotalWorkingEq_tmp_tmp = 0;
                          ...
                          workingset->ATwset[mTotalWorkingEq_tmp_tmp + 30 *
                            ...
                            ATwset[mTotalWorkingEq_tmp_tmp + 30 *
                            (workingset->nActiveConstr - 1)];
                        }
