...
// Last modified: 2021/05/11 18:38:59

#include "ammettenza/admittance_tank_cbf.h"

Admittance_Tank_CBF::Admittance_Tank_CBF()
{

  odometry_sub = nh.subscribe("/base_pose_ground_truth", 1, &Admittance_Tank_CBF::OdometryCallback, this);
  joints_state_sub = nh.subscribe("/joint_states", 1, &Admittance_Tank_CBF::JointStateCallback, this);
  joystick_sub = nh.subscribe("/joy", 1, &Admittance_Tank_CBF::joystickCallback, this);
...
//  twist.setZero();
  ...
  file_path4 << "/home/cristian/catkin_ws/src/mobile_robot/debug/energy_tank_debug.csv";
...
void Admittance_Tank_CBF::OdometryCallback(const nav_msgs::Odometry& msg)
{
...
void Admittance_Tank_CBF::joystickCallback(const sensor_msgs::Joy& msg)
{
...
void Admittance_Tank_CBF::JointStateCallback(const sensor_msgs::JointState::ConstPtr& msg)
{
...
Matrix4d Admittance_Tank_CBF::compute_arm_fk(double joint_position[],
...
Vector6d Admittance_Tank_CBF::compute_ee_pose(double joint_position[], double joint_velocity[]) {
    ...
    // Get the Translation Vector and Rotation Matrix
    Eigen::Vector3d translation_vector = end_effector_state.translation();
    translation_vector(0) -= 0.316;
    translation_vector(1) -= 0.085;
    translation_vector(2) -= 0.354;
...
Eigen::MatrixXd Admittance_Tank_CBF::compute_arm_jacobian(double joint_position[],
                                                      double joint_velocity[])
{
...
Matrix62d Admittance_Tank_CBF::compute_platform_jacobian(double rotation)
{
...
Matrix6d Admittance_Tank_CBF::Arm_Mapping(double rotation)
{
...
Matrix6d Admittance_Tank_CBF::Mir_Mapping(double rotation)
{
...
Matrix6d Admittance_Tank_CBF::Transformata(double rotation, int num)
{
...
Vector8d Admittance_Tank_CBF::limit_joints_dynamics(Vector8d joint_velocity)
{
...
Vector8d Admittance_Tank_CBF::SatNullSpace(Vector6d cartesian_velocity,
...
int Admittance_Tank_CBF::sign(double num)
{
...
void Admittance_Tank_CBF::Spinner()
{
...
//  }
  ...
  ROS_INFO_STREAM("h1:\t" << h_1 << "\n");
  ROS_INFO_STREAM("h2:\t" << h_2 << "\n");
  ROS_INFO_STREAM("Compilato:\t 07 \n");
